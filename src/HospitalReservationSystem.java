...
public class HospitalReservationSystem {
        ...
        try (Statement statement = connection.createStatement();
           ...
           // System.out.println("+--------------------- +------------------+-----------------+-----------------------+---------------------+ ");
            ...
            while (resultSet.next()) {
                ...
                //format and display the reservation data int a table-like format
    ...
    public static void main(String[] args)throws ClassNotFoundException,SQLException {
               try{
            Class.forName("com.mysql.cj.jdbc.Driver");//Driver manager class is loaded from com.mysql.cj package
        ...
        try{
            ...
            //getConnection is method that take three argument url,username,password this method is present in DriverManager Class
            while(true){
                System.out.println();
